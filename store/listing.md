...
- **Trader details (required for EEA distribution)**: Gareth Hall, personal developer account. Enter the postal address and phone in Play Console only; `TERMS.md` and `PRIVACY.md` point here for them rather than repeating them. Play blocks EEA distribution without the Digital Services Act trader declaration.
